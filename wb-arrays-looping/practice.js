...
function addItem(inputArray, num) {
  let addNum = inputArray.push(num);
  return inputArray;
}
...
function removeFirst(inputArray) {
  let removeFirst = inputArray.shift();
  return inputArray;
}
...
function count31() {
  let numbers = [];
  for (let i = 0; i < 32; i += 1) numbers.push(i);
...
function countEvens() {
  let numbers = [];
  for (let i = 0; i < 21; i += 2) numbers.push(i);
  return numbers;
}
...
function countdown() {
  let numbers = [];
  for (let i = 10; i > 0; i -= 1) numbers.push(i);
  return numbers;
}
...
function backwards(inputArray) {
  let newArray = [];
  for (let i = inputArray.length - 1; i >= 0; i--) newArray.push(inputArray[i]);
